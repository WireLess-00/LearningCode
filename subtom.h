...
#ifndef __SUBTOM__ /*Pour éviter d'inclure un fichier plusieurs fois à la compilation par erreur, temps de compilation plus rapide*/
#define __SUBTOM__ /*Gardiens = Protection si Subtom pas définit, il le définit*/
...
/*{
    printf("Je suis Tom et un esclave !\n");
}
