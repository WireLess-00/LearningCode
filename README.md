...
- **[Tic Tac Toe](mini-projets/tictactoe/)** — jeu à deux joueurs en console avec plateau 3x3
- **[Role Game](mini-projets/rolegame/)** — mini RPG en console avec création de personnage et système de combat
